...
/** Clase de gesti&oacute;n del registro.
 * @author Angel Gonzalez Villan
 * @author Jose Luis Escanciano Garcia */
public class CCIDUsbLogger {

	private static final String LOGGER_NAME = "es.gob.afirma"; //$NON-NLS-1$

	/** Debug log.
	 * @param o Mensaje */
	public static void d(final Object o) {
		Log.d(LOGGER_NAME, String.valueOf(o));
	}

	/** Info log.
	 * @param o Mensaje */
	public static void info(final Object o) {
		Log.i(LOGGER_NAME, String.valueOf(o));
	}

	/** Warning log.
	 * @param o Mensaje */
	public static void w(final Object o) {
		Log.w(LOGGER_NAME, String.valueOf(o));
	}

	/** Error log.
	 * @param o Mensaje */
	public static void e(final Object o) {
		Log.e(LOGGER_NAME, String.valueOf(o));
	}
}
