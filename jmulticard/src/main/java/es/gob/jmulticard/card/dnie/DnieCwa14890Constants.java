...
final class DnieCwa14890Constants implements Cwa14890PublicConstants, Cwa14890PrivateConstants {
	...
	private static final RSAPrivateKey IFD_PRIVATE_KEY = new RSAPrivateKey() {
		...
		public String toString() {
        	return "Clave privada RSA del certificado de Terminal para DNIe 2.0"; //$NON-NLS-1$
        }
