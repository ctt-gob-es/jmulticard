...
/** Tarjeta G&amp;D SmartCafe 3.2 con el Applet PKCS#15 de AET.
...
public final class AetPkcs15Applet extends Iso7816FourCard implements CryptoCard {
    ...
    /** Construye un objeto que representa una tarjeta G&amp;D SmartCafe 3.2 con el
    ...
    private void preloadCertificates() throws FileNotFoundException, Iso7816FourCardException, IOException, Asn1Exception, TlvException {
        ...
        // Seleccionamos el Applet PKCS#15 de AET
        selectFileByName(PKCS15_NAME);
