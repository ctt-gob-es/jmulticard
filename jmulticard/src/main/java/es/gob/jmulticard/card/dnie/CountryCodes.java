...
final class CountryCodes {
    ...
    static {
        ...
        CC.put("ATA", "Antarctica"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("ATF", "French Southern Territories"); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        CC.put("BEN", "Benin"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("BFA", "Burkina Faso"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("BGD", "Bangladesh"); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        CC.put("BOL", "Bolivia"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("BRA", "Brazil"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("BRB", "Barbados"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("BRN", "Brunei Darussalam"); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        CC.put("COK", "Cook Islands"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("COL", "Colombia"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("COM", "Comoros"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("CPV", "Cape Verde"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("CRI", "Costa Rica"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("CUB", "Cuba"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("CXR", "Christmas Island"); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        CC.put("GIB", "Gibraltar"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("GIN", "Guinea"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("GLP", "Guadeloupe"); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        CC.put("GUF", "French Guiana"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("GUM", "Guam"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("GUY", "Guyana"); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        CC.put("JPN", "Japan"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("KAZ", "Kazakhstan"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("KEN", "Kenya"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("KGZ", "Kyrgyzstan"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("KHM", "Cambodia"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("KIR", "Kiribati"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("KNA", "Saint Kitts and Nevis"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("KOR", "Korea, Republic of"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("KWT", "Kuwait"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("LAO", "Lao People's Democratic Republic"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("LBN", "Lebanon"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("LBR", "Liberia"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("LBY", "Libyan Arab Jamahiriya"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("LCA", "Saint Lucia"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("LIE", "Liechtenstein"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("LKA", "Sri Lanka"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("LSO", "Lesotho"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("LTU", "Lithuania"); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        CC.put("MDV", "Maldives"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("MEX", "Mexico"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("MHL", "Marshall Islands"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("MKD", "Macedonia, the former Yugoslav Republic of"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("MLI", "Mali"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("MLT", "Malta"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("MMR", "Myanmar"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("MNE", "Montenegro"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("MNG", "Mongolia"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("MNP", "Northern Mariana Islands"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("MOZ", "Mozambique"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("MRT", "Mauritania"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("MSR", "Montserrat"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("MTQ", "Martinique"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("MUS", "Mauritius"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("MWI", "Malawi"); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        CC.put("NIC", "Nicaragua"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("NIU", "Niue"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("NLD", "Netherlands"); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        CC.put("PCN", "Pitcairn"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("PER", "Peru"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("PHL", "Philippines"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("PLW", "Palau"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("PNG", "Papua New Guinea"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("POL", "Poland"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("PRI", "Puerto Rico"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("PRK", "Korea, Democratic People's Republic of"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("PRT", "Portugal"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("PRY", "Paraguay"); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        CC.put("SAU", "Saudi Arabia"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("SDN", "Sudan"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("SEN", "Senegal"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("SGP", "Singapore"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("SGS", "South Georgia and the South Sandwich Islands"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("SHN", "Saint Helena"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("SJM", "Svalbard and Jan Mayen"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("SLB", "Solomon Islands"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("SLE", "Sierra Leone"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("SLV", "El Salvador"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("SMR", "San Marino"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("SOM", "Somalia"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("SPM", "Saint Pierre and Miquelon"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("SRB", "Serbia"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("STP", "Sao Tome and Principe"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("SUR", "Suriname"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("SVK", "Slovakia"); //$NON-NLS-1$ //$NON-NLS-2$
        CC.put("SVN", "Slovenia"); //$NON-NLS-1$ //$NON-NLS-2$
