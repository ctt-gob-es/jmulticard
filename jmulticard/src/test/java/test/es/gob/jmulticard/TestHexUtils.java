...
/** Pruebas de los m&eacute;todos definidos en la clase de utilidades {@linkplain test.es.gob.jmulticard.HexUtils}
 * @author Alberto Mart&iacute;nez */
public class TestHexUtils extends TestCase {

    private static final byte[] HEXSTRING = "Prueba".getBytes(); //$NON-NLS-1$

    /** Prueba el m&eacute;todo {@linkplain test.es.gob.jmulticard.HexUtils#arrayEquals(byte[], byte[])} */
    ...
    /** Prueba el m&eacute;todo {@linkplain test.es.gob.jmulticard.HexUtils#arrayEquals(byte[], int, int, byte[], int, int)} */
    ...
    /** Prueba el m&eacute;todo {@linkplain test.es.gob.jmulticard.HexUtils#getShort(byte[], int)} */
    ...
    /** Prueba el m&eacute;todo {@linkplain test.es.gob.jmulticard.HexUtils#getUnsignedInt(byte[], int)} */
    ...
    /** Prueba el m&eacute;todo {@linkplain test.es.gob.jmulticard.HexUtils#hexify(byte[], boolean)} */
    ...
    /** Prueba el m&eacute;todo {@linkplain test.es.gob.jmulticard.HexUtils#subArray(byte[], int, int)} */
    ...
    /** Prueba el m&eacute;todo {@linkplain test.es.gob.jmulticard.HexUtils#xor(byte[], byte[])} */
