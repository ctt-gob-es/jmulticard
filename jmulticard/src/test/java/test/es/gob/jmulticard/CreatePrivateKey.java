...
public final class CreatePrivateKey {

	private static final BigInteger MODULUS = new BigInteger(1, new byte[] {
    ...
    private static final BigInteger PRIVATE_EXPONENT = new BigInteger(1, new byte[] {
	...
	public static void main(final String args[]) throws Exception {
        ...
        System.out.println(
    		HexUtils.hexify(priv.getEncoded(), true)
		);
	}
