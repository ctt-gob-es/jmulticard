...
/** Pruebas unitarias para la clase {@linkplain test.es.gob.jmulticard.asn1.Asn1Exception}
 * @author Alberto Mart&iacute;nez */
public class TestAsn1Exception extends TestCase {

    /** Test method for {@link test.es.gob.jmulticard.asn1.Asn1Exception#Asn1Exception(java.lang.String)}. */
    public final static void testAsn1ExceptionString() {
        Assert.assertNotNull(new Asn1Exception("")); //$NON-NLS-1$
    }

    /** Test method for {@link test.es.gob.jmulticard.asn1.Asn1Exception#Asn1Exception(java.lang.Throwable)}. */
    public final static void testAsn1ExceptionThrowable() {
        Assert.assertNotNull(new Asn1Exception(new Exception()));
    }

    /** Test method for {@link test.es.gob.jmulticard.asn1.Asn1Exception#Asn1Exception(java.lang.String, java.lang.Throwable)}. */
