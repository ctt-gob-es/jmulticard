...
public final class TestKeyGeneration {
	...
	private static final CryptoHelper cryptoHelper = new JseCryptoHelper();

	private static final byte[] kifd = new byte[] {
	...
	private static final byte[] kicc = new byte[] {
    ...
    private static byte[] generateKenc(final byte[] kidficc) throws IOException {
        ...
        System.arraycopy(
    		TestKeyGeneration.cryptoHelper.digest(
