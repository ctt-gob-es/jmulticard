...
public final class CommonPasswordCallback extends PasswordCallback {
	...
	public CommonPasswordCallback(final String prompt,
		...
		isDnie = isDni;
		allowUseCache = allowPinCache;
		defaultUseCacheValue = defaultPinCacheValue;
		useCacheChecked = defaultUseCacheValue;
	}
    ...
    public char[] getPassword() {
	    if (!headless) {
    		try {
    			...
    			useCacheChecked = psc.isUseCacheChecked();
    			psc.clearPassword();
    			psc = null;
