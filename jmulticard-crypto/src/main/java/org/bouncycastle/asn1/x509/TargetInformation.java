...
public class TargetInformation
    extends ASN1Object
{
    private final ASN1Sequence targets;
     ...
     */
    public static TargetInformation getInstance(final Object obj)
    {
     ...
     */
    private TargetInformation(final ASN1Sequence seq)
    {
        targets = seq;
    }
    ...
    {
        final Targets[] copy = new Targets[targets.size()];
        int count = 0;
        for (final Object target : targets) {
            copy[count++] = Targets.getInstance(target);
        }
        return copy;
    }
     ...
     */
    public TargetInformation(final Target[] targets)
    {
