    ...
    extends ASN1Object
{
    ...
    private final ASN1BitString bitString;

    public static KeyUsage getInstance(final Object obj)   // needs to be DERBitString for other VMs
    {
     ...
     */
    public boolean hasUsages(final int usages)
    {
    ...
    {
        final byte[] data = bitString.getBytes();
