...
public class ANSSINamedCurves {
    ...
    static X9ECParametersHolder FRP256v1 = new X9ECParametersHolder() {
        ...
        {
            final BigInteger p = fromHex("F1FD178C0B3AD58F10126DE8CE42435B3961ADBCABC8CA6DE8FCF353D86E9C03"); //$NON-NLS-1$
            final BigInteger a = fromHex("F1FD178C0B3AD58F10126DE8CE42435B3961ADBCABC8CA6DE8FCF353D86E9C00"); //$NON-NLS-1$
            final BigInteger b = fromHex("EE353FCA5428A9300D4ABA754A44C00FDFEC0C9AE4B1A1803075ED967B7BB73F"); //$NON-NLS-1$
            final BigInteger n = fromHex("F1FD178C0B3AD58F10126DE8CE42435B53DC67E140D2BF941FFDD459C6D655E1"); //$NON-NLS-1$
		...
		protected X9ECParameters createParameters() {
            final byte[] S = null;
            final ECCurve curve = createCurve();

            final X9ECPoint G = configureBasepoint(curve,
                "04B6B3D4C356C139EB31183D4749D423958C27D2DCAF98B70164C97A2DD98F5CFF6142E0F7C8B204911F9271F0F3ECEF8C2701C307E8E4C9E183115A1554062CFB"); //$NON-NLS-1$
    ...
    static
    {
        defineCurve("FRP256v1", ANSSIObjectIdentifiers.FRP256v1, FRP256v1); //$NON-NLS-1$
    }
