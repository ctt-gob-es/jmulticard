...
public class CustomNamedCurves
{
    ...
    static X9ECParametersHolder curve25519 = new X9ECParametersHolder()
    {
		...
		protected X9ECParameters createParameters()
        {
            ...
            final X9ECPoint G = configureBasepoint(curve,
                "042AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAD245A20AE19A1B8A086B4E01EDD2C7748D14C923D4D7E6D7C61B229E9C5A27ECED3D9"); //$NON-NLS-1$
    ...
    static X9ECParametersHolder secp224k1 = new X9ECParametersHolder()
    {
        ...
        {
            final GLVTypeBParameters glv = new GLVTypeBParameters(
                new BigInteger("fe0e87005b4e83761908c5131d552a850b3f58b749c37cf5b84d6768", 16), //$NON-NLS-1$
                new BigInteger("60dcd2104c4cbc0be6eeefc2bdd610739ec34e317f9b33046c9e4788", 16), //$NON-NLS-1$
                new ScalarSplitParameters(
                    new BigInteger[]{
                        new BigInteger("6b8cf07d4ca75c88957d9d670591", 16), //$NON-NLS-1$
                        new BigInteger("-b8adf1378a6eb73409fa6c9c637d", 16) }, //$NON-NLS-1$
                    new BigInteger[]{
                        new BigInteger("1243ae1b4d71613bc9f780a03690e", 16), //$NON-NLS-1$
                        new BigInteger("6b8cf07d4ca75c88957d9d670591", 16) }, //$NON-NLS-1$
                    new BigInteger("6b8cf07d4ca75c88957d9d67059037a4", 16), //$NON-NLS-1$
                    new BigInteger("b8adf1378a6eb73409fa6c9c637ba7f5", 16), //$NON-NLS-1$
                    240));
		...
		protected X9ECParameters createParameters()
        {
            ...
            final ECCurve curve = getCurve();
            final X9ECPoint G = configureBasepoint(curve,
                "04A1455B334DF099DF30FC28A169A467E9E47075A90F7E650EB6B7A45C7E089FED7FBA344282CAFBD6F7E319F7C0B0BD59E2CA4BDB556D61A5"); //$NON-NLS-1$
            return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
        }
    };
    ...
    static X9ECParametersHolder secp224r1 = new X9ECParametersHolder()
    {
		...
		protected X9ECParameters createParameters()
        {
            final byte[] S = Hex.decodeStrict("BD71344799D5C7FCDC45B59FA3B9AB8F6A948BC5"); //$NON-NLS-1$
            final ECCurve curve = getCurve();
            final X9ECPoint G = configureBasepoint(curve,
                "04B70E0CBD6BB4BF7F321390B94A03C1D356C21122343280D6115C1D21BD376388B5F723FB4C22DFE6CD4375A05A07476444D5819985007E34"); //$NON-NLS-1$
            return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
        }
    };
    ...
    static X9ECParametersHolder secp256k1 = new X9ECParametersHolder()
    {
        ...
        {
            final GLVTypeBParameters glv = new GLVTypeBParameters(
                new BigInteger("7ae96a2b657c07106e64479eac3434e99cf0497512f58995c1396c28719501ee", 16), //$NON-NLS-1$
                new BigInteger("5363ad4cc05c30e0a5261c028812645a122e22ea20816678df02967c1b23bd72", 16), //$NON-NLS-1$
                new ScalarSplitParameters(
                    new BigInteger[]{
                        new BigInteger("3086d221a7d46bcde86c90e49284eb15", 16), //$NON-NLS-1$
                        new BigInteger("-e4437ed6010e88286f547fa90abfe4c3", 16) }, //$NON-NLS-1$
                    new BigInteger[]{
                        new BigInteger("114ca50f7a8e2f3f657c1108d9d44cfd8", 16), //$NON-NLS-1$
                        new BigInteger("3086d221a7d46bcde86c90e49284eb15", 16) }, //$NON-NLS-1$
                    new BigInteger("3086d221a7d46bcde86c90e49284eb153dab", 16), //$NON-NLS-1$
                    new BigInteger("e4437ed6010e88286f547fa90abfe4c42212", 16), //$NON-NLS-1$
                    272));
		...
		protected X9ECParameters createParameters()
        {
            ...
            final ECCurve curve = getCurve();
            final X9ECPoint G = configureBasepoint(curve,
                "0479BE667EF9DCBBAC55A06295CE870B07029BFCDB2DCE28D959F2815B16F81798483ADA7726A3C4655DA4FBFC0E1108A8FD17B448A68554199C47D08FFB10D4B8"); //$NON-NLS-1$
            return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
        }
    };
    ...
    static X9ECParametersHolder secp256r1 = new X9ECParametersHolder()
    {
		...
		protected X9ECParameters createParameters()
        {
            ...
            final ECCurve curve = getCurve();
            final X9ECPoint G = configureBasepoint(curve,
                "046B17D1F2E12C4247F8BCE6E563A440F277037D812DEB33A0F4A13945D898C2964FE342E2FE1A7F9B8EE7EB4A7C0F9E162BCE33576B315ECECBB6406837BF51F5"); //$NON-NLS-1$
            return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
        }
    };
    ...
    static X9ECParametersHolder secp384r1 = new X9ECParametersHolder()
    {
		...
		protected X9ECParameters createParameters()
        {
            final byte[] S = Hex.decodeStrict("A335926AA319A27A1D00896A6773A4827ACDAC73"); //$NON-NLS-1$
            final ECCurve curve = getCurve();
            final X9ECPoint G = configureBasepoint(curve, "04" //$NON-NLS-1$
                + "AA87CA22BE8B05378EB1C71EF320AD746E1D3B628BA79B9859F741E082542A385502F25DBF55296C3A545E3872760AB7" //$NON-NLS-1$
                + "3617DE4A96262C6F5D9E98BF9292DC29F8F41DBD289A147CE9DA3113B5F0B8C00A60B1CE1D7E819D7A431D7C90EA0E5F"); //$NON-NLS-1$
            return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
        }
    };
    ...
    static X9ECParametersHolder secp521r1 = new X9ECParametersHolder()
    {
		...
		protected X9ECParameters createParameters()
        {
            final byte[] S = Hex.decodeStrict("D09E8800291CB85396CC6717393284AAA0DA64BA"); //$NON-NLS-1$
            final ECCurve curve = getCurve();
            final X9ECPoint G = configureBasepoint(curve, "04" //$NON-NLS-1$
                + "00C6858E06B70404E9CD9E3ECB662395B4429C648139053FB521F828AF606B4D3DBAA14B5E77EFE75928FE1DC127A2FFA8DE3348B3C1856A429BF97E7E31C2E5BD66" //$NON-NLS-1$
                + "011839296A789A3BC0045C8A5FB42C7D1BD998F54449579B446817AFBD17273E662C97EE72995EF42640C550B9013FAD0761353C7086A272C24088BE94769FD16650"); //$NON-NLS-1$
            return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
        }
    };
    ...
    static X9ECParametersHolder sect113r1 = new X9ECParametersHolder()
    {
		...
		protected X9ECParameters createParameters()
        {
            final byte[] S = Hex.decodeStrict("10E723AB14D696E6768756151756FEBF8FCB49A9"); //$NON-NLS-1$
            final ECCurve curve = getCurve();
            final X9ECPoint G = configureBasepoint(curve,
                "04009D73616F35F4AB1407D73562C10F00A52830277958EE84D1315ED31886"); //$NON-NLS-1$
            return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
        }
    };
    ...
    static X9ECParametersHolder sect113r2 = new X9ECParametersHolder()
    {
		...
		protected X9ECParameters createParameters()
        {
            final byte[] S = Hex.decodeStrict("10C0FB15760860DEF1EEF4D696E676875615175D"); //$NON-NLS-1$
            final ECCurve curve = getCurve();
            final X9ECPoint G = configureBasepoint(curve,
                "0401A57A6A7B26CA5EF52FCDB816479700B3ADC94ED1FE674C06E695BABA1D"); //$NON-NLS-1$
            return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
        }
    };
    ...
    static X9ECParametersHolder sect131r1 = new X9ECParametersHolder()
    {
		...
		protected X9ECParameters createParameters()
        {
            final byte[] S = Hex.decodeStrict("4D696E676875615175985BD3ADBADA21B43A97E2"); //$NON-NLS-1$
            final ECCurve curve = getCurve();
            final X9ECPoint G = configureBasepoint(curve,
                "040081BAF91FDF9833C40F9C181343638399078C6E7EA38C001F73C8134B1B4EF9E150"); //$NON-NLS-1$
            return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
        }
    };
    ...
    static X9ECParametersHolder sect131r2 = new X9ECParametersHolder()
    {
		...
		protected X9ECParameters createParameters()
        {
            final byte[] S = Hex.decodeStrict("985BD3ADBAD4D696E676875615175A21B43A97E3"); //$NON-NLS-1$
            final ECCurve curve = getCurve();
            final X9ECPoint G = configureBasepoint(curve,
                "040356DCD8F2F95031AD652D23951BB366A80648F06D867940A5366D9E265DE9EB240F"); //$NON-NLS-1$
            return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
        }
    };
    ...
    static X9ECParametersHolder sect163k1 = new X9ECParametersHolder()
    {
		...
		protected X9ECParameters createParameters()
        {
            ...
            final ECCurve curve = getCurve();
            final X9ECPoint G = configureBasepoint(curve,
                "0402FE13C0537BBC11ACAA07D793DE4E6D5E5C94EEE80289070FB05D38FF58321F2E800536D538CCDAA3D9"); //$NON-NLS-1$
            return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
        }
    };
    ...
    static X9ECParametersHolder sect163r1 = new X9ECParametersHolder()
    {
		...
		protected X9ECParameters createParameters()
        {
            final byte[] S = Hex.decodeStrict("24B7B137C8A14D696E6768756151756FD0DA2E5C"); //$NON-NLS-1$
            final ECCurve curve = getCurve();
            final X9ECPoint G = configureBasepoint(curve,
                "040369979697AB43897789566789567F787A7876A65400435EDB42EFAFB2989D51FEFCE3C80988F41FF883"); //$NON-NLS-1$
            return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
        }
    };
    ...
    static X9ECParametersHolder sect163r2 = new X9ECParametersHolder()
    {
		...
		protected X9ECParameters createParameters()
        {
            final byte[] S = Hex.decodeStrict("85E25BFE5C86226CDB12016F7553F9D0E693A268"); //$NON-NLS-1$
            final ECCurve curve = getCurve();
            final X9ECPoint G = configureBasepoint(curve,
                "0403F0EBA16286A2D57EA0991168D4994637E8343E3600D51FBC6C71A0094FA2CDD545B11C5C0C797324F1"); //$NON-NLS-1$
            return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
        }
    };
    ...
    static X9ECParametersHolder sect193r1 = new X9ECParametersHolder()
    {
		...
		protected X9ECParameters createParameters()
        {
            final byte[] S = Hex.decodeStrict("103FAEC74D696E676875615175777FC5B191EF30"); //$NON-NLS-1$
            final ECCurve curve = getCurve();
            final X9ECPoint G = configureBasepoint(curve,
                "0401F481BC5F0FF84A74AD6CDF6FDEF4BF6179625372D8C0C5E10025E399F2903712CCF3EA9E3A1AD17FB0B3201B6AF7CE1B05"); //$NON-NLS-1$
            return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
        }
    };
    ...
    static X9ECParametersHolder sect193r2 = new X9ECParametersHolder()
    {
		...
		protected X9ECParameters createParameters()
        {
            final byte[] S = Hex.decodeStrict("10B7B4D696E676875615175137C8A16FD0DA2211"); //$NON-NLS-1$
            final ECCurve curve = getCurve();
            final X9ECPoint G = configureBasepoint(curve,
                "0400D9B67D192E0367C803F39E1A7E82CA14A651350AAE617E8F01CE94335607C304AC29E7DEFBD9CA01F596F927224CDECF6C"); //$NON-NLS-1$
            return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
        }
    };
    ...
    static X9ECParametersHolder sect233k1 = new X9ECParametersHolder()
    {
		...
		protected X9ECParameters createParameters()
        {
            ...
            final ECCurve curve = getCurve();
            final X9ECPoint G = configureBasepoint(curve,
                "04017232BA853A7E731AF129F22FF4149563A419C26BF50A4C9D6EEFAD612601DB537DECE819B7F70F555A67C427A8CD9BF18AEB9B56E0C11056FAE6A3"); //$NON-NLS-1$
            return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
        }
    };
    ...
    static X9ECParametersHolder sect233r1 = new X9ECParametersHolder()
    {
		...
		protected X9ECParameters createParameters()
        {
            final byte[] S = Hex.decodeStrict("74D59FF07F6B413D0EA14B344B20A2DB049B50C3"); //$NON-NLS-1$
            final ECCurve curve = getCurve();
            final X9ECPoint G = configureBasepoint(curve,
                "0400FAC9DFCBAC8313BB2139F1BB755FEF65BC391F8B36F8F8EB7371FD558B01006A08A41903350678E58528BEBF8A0BEFF867A7CA36716F7E01F81052"); //$NON-NLS-1$
            return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
        }
    };
    ...
    static X9ECParametersHolder sect239k1 = new X9ECParametersHolder()
    {
		...
		protected X9ECParameters createParameters()
        {
            ...
            final ECCurve curve = getCurve();
            final X9ECPoint G = configureBasepoint(curve,
                "0429A0B6A887A983E9730988A68727A8B2D126C44CC2CC7B2A6555193035DC76310804F12E549BDB011C103089E73510ACB275FC312A5DC6B76553F0CA"); //$NON-NLS-1$
            return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
        }
    };
    ...
    static X9ECParametersHolder sect283k1 = new X9ECParametersHolder()
    {
		...
		protected X9ECParameters createParameters()
        {
            ...
            final ECCurve curve = getCurve();
            final X9ECPoint G = configureBasepoint(curve, "04" //$NON-NLS-1$
                + "0503213F78CA44883F1A3B8162F188E553CD265F23C1567A16876913B0C2AC2458492836" //$NON-NLS-1$
                + "01CCDA380F1C9E318D90F95D07E5426FE87E45C0E8184698E45962364E34116177DD2259"); //$NON-NLS-1$
            return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
        }
    };
    ...
    static X9ECParametersHolder sect283r1 = new X9ECParametersHolder()
    {
		...
		protected X9ECParameters createParameters()
        {
            final byte[] S = Hex.decodeStrict("77E2B07370EB0F832A6DD5B62DFC88CD06BB84BE"); //$NON-NLS-1$
            final ECCurve curve = getCurve();
            final X9ECPoint G = configureBasepoint(curve, "04" //$NON-NLS-1$
                + "05F939258DB7DD90E1934F8C70B0DFEC2EED25B8557EAC9C80E2E198F8CDBECD86B12053" //$NON-NLS-1$
                + "03676854FE24141CB98FE6D4B20D02B4516FF702350EDDB0826779C813F0DF45BE8112F4"); //$NON-NLS-1$
            return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
        }
    };
    ...
    static X9ECParametersHolder sect409k1 = new X9ECParametersHolder()
    {
		...
		protected X9ECParameters createParameters()
        {
            ...
            final ECCurve curve = getCurve();
            final X9ECPoint G = configureBasepoint(curve, "04" //$NON-NLS-1$
                + "0060F05F658F49C1AD3AB1890F7184210EFD0987E307C84C27ACCFB8F9F67CC2C460189EB5AAAA62EE222EB1B35540CFE9023746" //$NON-NLS-1$
                + "01E369050B7C4E42ACBA1DACBF04299C3460782F918EA427E6325165E9EA10E3DA5F6C42E9C55215AA9CA27A5863EC48D8E0286B"); //$NON-NLS-1$
            return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
        }
    };
    ...
    static X9ECParametersHolder sect409r1 = new X9ECParametersHolder()
    {
		...
		protected X9ECParameters createParameters()
        {
            final byte[] S = Hex.decodeStrict("4099B5A457F9D69F79213D094C4BCD4D4262210B"); //$NON-NLS-1$
            final ECCurve curve = getCurve();
            final X9ECPoint G = configureBasepoint(curve, "04" //$NON-NLS-1$
                + "015D4860D088DDB3496B0C6064756260441CDE4AF1771D4DB01FFE5B34E59703DC255A868A1180515603AEAB60794E54BB7996A7" //$NON-NLS-1$
                + "0061B1CFAB6BE5F32BBFA78324ED106A7636B9C5A7BD198D0158AA4F5488D08F38514F1FDF4B4F40D2181B3681C364BA0273C706"); //$NON-NLS-1$
            return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
        }
    };
    ...
    static X9ECParametersHolder sect571k1 = new X9ECParametersHolder()
    {
		...
		protected X9ECParameters createParameters()
        {
            ...
            final ECCurve curve = getCurve();
            final X9ECPoint G = configureBasepoint(curve, "04" //$NON-NLS-1$
                + "026EB7A859923FBC82189631F8103FE4AC9CA2970012D5D46024804801841CA44370958493B205E647DA304DB4CEB08CBBD1BA39494776FB988B47174DCA88C7E2945283A01C8972" //$NON-NLS-1$
                + "0349DC807F4FBF374F4AEADE3BCA95314DD58CEC9F307A54FFC61EFC006D8A2C9D4979C0AC44AEA74FBEBBB9F772AEDCB620B01A7BA7AF1B320430C8591984F601CD4C143EF1C7A3"); //$NON-NLS-1$
            return new X9ECParameters(curve, G, curve.getOrder(), curve.getCofactor(), S);
        }
    };
    ...
    static void defineCurve(String name, final X9ECParametersHolder holder)
    {
    ...
    static void defineCurveWithOID(String name, final ASN1ObjectIdentifier oid, final X9ECParametersHolder holder)
    {
        names.addElement(name);
    ...
    static void defineCurveAlias(String name, final ASN1ObjectIdentifier oid)
    {
        final Object curve = oidToCurve.get(oid);
        if (curve == null)
        {
...
//        defineCurveWithOID("secp128r2", SECObjectIdentifiers.secp128r2, secp128r2);
    ...
    {
        final X9ECParametersHolder holder = getByNameLazy(name);
    ...
    /**
     * @return an enumeration containing the name strings for curves contained in this structure.
     */
