...
public final class CryptoServicesRegistrar
{
    ...
    {
        @Override
		public void check(final CryptoServiceProperties service)
        {
             // anything goes.
        }
    };
    ...
    static
    {
        ...
        final DSAParameters def512Params = new DSAParameters(
        ...
        final DSAParameters def768Params = new DSAParameters(
        ...
        final DSAParameters def1024Params = new DSAParameters(
        ...
        final DSAParameters def2048Params = new DSAParameters(
     ...
     */
    public static SecureRandom getSecureRandom(final SecureRandom secureRandom)
    {
     ...
     */
    public static void setSecureRandomProvider(final SecureRandomProvider secureRandomProvider)
    {
        checkPermission(CanSetDefaultRandom);
    ...
    public static void setServicesConstraints(final CryptoServicesConstraints constraints)
    {
        ...
        final CryptoServicesConstraints newConstraints = constraints == null ? noConstraintsImpl : constraints;
     ...
     */
    public static <T> T getProperty(final Property property)
    {
        final Object[] values = lookupProperty(property);
    ...
    private static Object[] lookupProperty(final Property property)
    {
        final Map<String, Object[]> properties = threadProperties.get();
        Object[] values;
     ...
     */
    public static <T> T[] getSizedProperty(final Property property)
    {
        final Object[] values = lookupProperty(property);
     ...
     */
    public static <T> T getSizedProperty(final Property property, final int size)
    {
        final Object[] values = lookupProperty(property);
        ...
        if (property.type.isAssignableFrom(DHParameters.class))
        {
            for (final Object value : values) {
                final DHParameters params = (DHParameters)value;
        ...
        {
            for (final Object value : values) {
                final DSAParameters params = (DSAParameters)value;
     ...
     */
    public static <T> void setThreadProperty(final Property property, final T... propertyValue)
    {
     ...
     * @param <T>           the base type of the property value.
     */
    public static <T> void setGlobalProperty(final Property property, final T... propertyValue)
    {
    ...
    private static <T> void localSetThread(final Property property, final T[] propertyValue)
    {
    ...
    private static <T> void localSetGlobalProperty(final Property property, final T... propertyValue)
    {
        if (!property.type.isAssignableFrom(propertyValue[0].getClass()))
        {
            throw new IllegalArgumentException("Bad property value passed");
     ...
     */
    public static <T> T[] clearGlobalProperty(final Property property)
    {
        checkPermission(CanSetDefaultProperty);
     ...
     * @return an array of T if a value was previously set, null otherwise.
     */
    public static <T> T[] clearThreadProperty(final Property property)
    {
        checkPermission(CanSetThreadProperty);
    ...
    private static Object[] localClearThreadProperty(final Property property)
    {
        Map<String, Object[]> properties = threadProperties.get();
    ...
    private static DHParameters toDH(final DSAParameters dsaParams)
    {
        final int pSize = dsaParams.getP().bitLength();
        final int m = chooseLowerBound(pSize);
    ...
    private static int chooseLowerBound(final int pSize)
    {
        int m = 160;
        if (pSize > 1024)
        {
    ...
    public static final class Property
    {
        ...
        private Property(final String name, final Class type)
        {
            this.name = name;
            this.type = type;
        }
