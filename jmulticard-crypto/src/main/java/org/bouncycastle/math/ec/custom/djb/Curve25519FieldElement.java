...
public class Curve25519FieldElement extends ECFieldElement.AbstractFp
{
    ...
    private static final int[] PRECOMP_POW2 = { 0x4a0ea0b0, 0xc4ee1b27, 0xad2fe478, 0x2f431806,
        0x3dfbd7a7, 0x2b4d0099, 0x4fc1df0b, 0x2b832480 };

    protected int[] x;

    public Curve25519FieldElement(final BigInteger x)
    {
...
//        return new Curve25519FieldElement(toBigInteger().modInverse(Q));
	...
	public boolean equals(final Object other)
    {
        ...
        final Curve25519FieldElement o = (Curve25519FieldElement)other;
