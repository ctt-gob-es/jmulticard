...
public class SecT409FieldElement extends ECFieldElement.AbstractF2m
{
    ...
    public SecT409FieldElement(final BigInteger x)
    {
...
//    }
    ...
    {
        final long[] ax = this.x, bx = ((SecT409FieldElement)b).x;
        final long[] xx = ((SecT409FieldElement)x).x, yx = ((SecT409FieldElement)y).x;

        final long[] tt = Nat.create64(13);
	...
	public boolean equals(final Object other)
    {
        ...
        final SecT409FieldElement o = (SecT409FieldElement)other;
