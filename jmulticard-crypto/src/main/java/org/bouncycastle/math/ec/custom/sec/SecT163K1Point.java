...
{
    SecT163K1Point(final ECCurve curve, final ECFieldElement x, final ECFieldElement y)
    {
        super(curve, x, y);
    }

    SecT163K1Point(final ECCurve curve, final ECFieldElement x, final ECFieldElement y, final ECFieldElement[] zs)
    {
        super(curve, x, y, zs);
    }
	...
	public ECPoint twice()
    {
        ...
        final ECFieldElement L3 = t1.add(T).add(Z1Sq).multiply(t1).add(X3);
