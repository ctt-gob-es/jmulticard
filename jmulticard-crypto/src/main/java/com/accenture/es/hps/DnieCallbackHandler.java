...
final class DnieCallbackHandler implements CallbackHandler {
	 ...
	 * @param c CAN.
	 * @param p PIN. */
	DnieCallbackHandler(final String c, final String p) {
		can = c;
	 ...
	 * @param c CAN.
	 * @param p PIN. */
	DnieCallbackHandler(final String c, final char[] p) {
		can = c;
		pin = p != null ? p.clone() : null;
	}

	private static final Logger LOGGER = Logger.getLogger(DnieCallbackHandler.class.getName());
