...
public final class Ceres430Provider extends Provider {
    ...
    public Ceres430Provider(final ApduConnection conn) {
        ...
        // KeyStore
        put("KeyStore.CERES430", "es.gob.jmulticard.jse.provider.Ceres430KeyStoreImpl"); //$NON-NLS-1$ //$NON-NLS-2$
        ...
        // Claves soportadas
        put("Signature.SHA1withRSA SupportedKeyClasses", Ceres430Provider.DNIE_PRIVATE_KEY); //$NON-NLS-1$
        put("Signature.SHA256withRSA SupportedKeyClasses", Ceres430Provider.DNIE_PRIVATE_KEY); //$NON-NLS-1$
        put("Signature.SHA384withRSA SupportedKeyClasses", Ceres430Provider.DNIE_PRIVATE_KEY); //$NON-NLS-1$
        put("Signature.SHA512withRSA SupportedKeyClasses", Ceres430Provider.DNIE_PRIVATE_KEY); //$NON-NLS-1$
